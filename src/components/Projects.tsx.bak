        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          {projects.map((project, index) => (
            <motion.button
              ...
              className={`group relative flex flex-col overflow-hidden rounded-3xl border text-left shadow-2xl backdrop-blur-xl transition-all duration-300 hover:bg-white/[0.12] hover:shadow-[0_0_55px_rgba(34,211,238,0.22)] ${projectCardThemeMap[project.tagColor]}`}
            >
              <div className="absolute -right-20 -top-20 h-44 w-44 rounded-full bg-white/20 blur-3xl transition group-hover:bg-cyan-300/25" />
        ...
        >
          <div className="relative max-h-[92vh] w-full max-w-7xl overflow-y-auto rounded-3xl border border-blue-300/20 bg-[#061225] shadow-2xl shadow-blue-950/70">
            <button
              ...
              className="absolute right-5 top-5 z-30 rounded-full bg-white/90 p-2 text-slate-700 shadow-lg hover:bg-white"
              aria-label="Close"
            >
              <X size={20} />
            </button>
                    ...
                    <>
                      <div className="relative overflow-hidden rounded-2xl border border-blue-300/20 bg-slate-950">
                        ...
                        <button
                          ...
                          className="absolute left-4 top-1/2 z-20 -translate-y-1/2 rounded-full bg-slate-950/70 p-3 text-white hover:bg-blue-600"
                        ...
                        <button
                          onClick={nextImage}
                          className="absolute right-4 top-1/2 z-20 -translate-y-1/2 rounded-full bg-slate-950/70 p-3 text-white hover:bg-blue-600"
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/90 px-4 py-6">
          <div className="relative w-full max-w-7xl">
            <button
              ...
              className="absolute right-4 top-4 z-30 rounded-full bg-white/90 p-2 text-slate-700 shadow-lg hover:bg-white"
            ...
            <div className="relative overflow-hidden rounded-3xl border border-blue-300/30 bg-slate-950 p-3 shadow-2xl shadow-blue-950">
              ...
              <button
                onClick={previousImage}
                className="absolute left-5 top-1/2 z-30 -translate-y-1/2 rounded-full bg-slate-950/75 p-4 text-white hover:bg-blue-600"
              ...
              <button
                onClick={nextImage}
                className="absolute right-5 top-1/2 z-30 -translate-y-1/2 rounded-full bg-slate-950/75 p-4 text-white hover:bg-blue-600"
            ...
            <div className="mt-4 flex items-start justify-between gap-4 rounded-2xl border border-white/10 bg-white/[0.06] p-4 text-white backdrop-blur-xl">
              <div>
...
function Watermark() {
  return (
    <>
      <div className="pointer-events-none absolute left-5 top-5 z-10 rounded-2xl border border-white/50 bg-white/85 px-3 py-2 shadow-xl backdrop-blur-md">
        <img
      ...
      <div className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center">
        <div className="-rotate-12 rounded-3xl border border-blue-300/20 bg-white/10 px-8 py-4 text-3xl font-black tracking-[0.25em] text-white/12 backdrop-blur-[1px]">
          MIKEOPS.PRO
        </div>
      </div>
    </>
